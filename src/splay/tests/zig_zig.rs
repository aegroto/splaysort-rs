...
fn test_zig_zig_with_all_children_and_relatives() {
    ...
    splay_tree.binary_insert(10);
    splay_tree.binary_insert(12);
...
#[test]
fn test_zig_zig_then_zag_zig_with_missing_key() {
    // Setup
    let mut splay_tree = default_start_tree();
...
#[test]
fn test_zig_zig_then_zag_zag_with_missing_key() {
    // Setup
    let mut splay_tree = default_start_tree();
    ...
    // Verification
    let expected_tree = "TopDownSplayTree { root: Some(SplayNode { key: 7, left: Some(SplayNode { key: 3, left: Some(SplayNode { key: 1, left: None, right: None }), right: None }), right: Some(SplayNode { key: 9, left: None, right: Some(SplayNode { key: 11, left: None, right: None }) }) }) }";
